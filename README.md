...
-----------------
docker exec -it lee_kafka1 kafka-topics   --bootstrap-server kafka1:29092   --list
docker exec -it lee_kafka1 kafka-topics --bootstrap-server kafka1:29092 --create --topic financial_fraud --partitions 6 --replication-factor 3
  
docker exec -it lee_kafka1 kafka-console-consumer --bootstrap-server kafka1:29092 --topic financial_fraud  --from-beginning
